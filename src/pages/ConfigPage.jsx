                ...
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <div style={{ borderTop: '1px solid var(--border)', paddingTop: 12, marginTop: 4 }}>
                      ...
                      <NumSlider label="Módulo do Barcode (largura barras)" value={layoutNilit.barcodeModule} min={1} max={4} step={0.01} onChange={v => setLayoutNilitLocal(l => ({...l, barcodeModule: v}))} />
