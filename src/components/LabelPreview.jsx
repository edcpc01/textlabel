...
function CelulaEtiqueta({ record, fusoNum, layout = {} }) {
  ...
  return (
    <div style={{
      ...
      {/* L1 Empresa */}
      <div style={{ textAlign: 'center', fontSize: fEmp.size, fontWeight: fEmp.bold ? 900 : 700, textShadow: fEmp.bold ? '0.3px 0px 0px black, 0px 0.3px 0px black' : 'none', lineHeight: 1.15, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
        {empresa || '— EMPRESA —'}
      </div>
      {/* L2 CNPJ */}
      <div style={{ textAlign: 'center', fontSize: fCnpj.size, fontWeight: fCnpj.bold ? 900 : 400, textShadow: fCnpj.bold ? '0.3px 0px 0px black, 0px 0.3px 0px black' : 'none', lineHeight: 1.15 }}>
        {cnpj ? `CNPJ: ${cnpj}` : '—'}
      </div>
      {/* L3 Descrição */}
      <div style={{ textAlign: 'center', fontSize: fDesc.size, fontWeight: fDesc.bold ? 900 : 700, textShadow: fDesc.bold ? '0.3px 0px 0px black, 0px 0.3px 0px black' : 'none', lineHeight: 1.15, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
        {descricao || '—'}
      </div>
      {/* L4 Composição */}
      <div style={{ textAlign: 'center', fontSize: fComp.size, fontWeight: fComp.bold ? 900 : 400, textShadow: fComp.bold ? '0.3px 0px 0px black, 0px 0.3px 0px black' : 'none', lineHeight: 1.15 }}>
        {compTit}
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div style={{ fontSize: fCode.size, fontWeight: fCode.bold ? 900 : 700, textShadow: fCode.bold ? '0.5px 0px 0px black, 0px 0.5px 0px black' : 'none', letterSpacing: 0.5, lineHeight: 1 }}>{code1}</div>
